...
class payment(olacabs):
  
  def __init__(self,name,email,loc,phno,upicode,access):
...
class custCabs(payment):
   def __init__(self,name,email,loc,phno,upicode,access,gender):
      super().__init__(name,email,loc,phno,upicode,access)
